...
//    }
    ...
    public void update2(String name,String surname,String birth){
        try {
            PreparedStatement ps = conn.prepareStatement("UPDATE Person SET name = ?,surname = ?,birthDate = ? WHERE id = 1");
            ps.setString(1,name);
